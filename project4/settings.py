...
AUTH_USER_MODEL = "Magical_first_website.User_in_magical_website" 
...
DEBUG = True
print("from settings--> ",os.getenv('DEBUG'))
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'Magical_first_website', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_MAIL_HTML = 'template_for_email.html'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'monishsharma010@gmail.com'
EMAIL_HOST_PASSWORD = 'kzeu whzh jvlh lrlv'  # os.environ['password_key'] suggested
EMAIL_USE_TLS = True